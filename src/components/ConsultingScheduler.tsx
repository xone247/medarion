...
const ConsultingScheduler: React.FC = () => {
  ...
  return (
    <div className="bg-background-surface p-6 rounded-lg border border-divider space-y-4">
      <h3 className="text-lg font-medium text-text-primary">Schedule a Consulting Call</h3>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-3">
        ...
        <textarea className="col-span-2 px-3 py-2 border border-divider rounded-lg bg-background text-text-primary" rows={3} placeholder="Describe your needs..." value={topic} onChange={(e)=>setTopic(e.target.value)} />
