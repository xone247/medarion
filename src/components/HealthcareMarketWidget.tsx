  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-4 p-6 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
      <div className="flex items-center space-x-2 mb-4">
        ...
        <h3 className="text-base text-lg font-medium text-gray-900 dark:text-white">Healthcare Market Insights</h3>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          <h4 className="text-xs text-sm font-medium text-gray-900 dark:text-white mb-3">Priority Markets by Health Needs</h4>
            ...
            {topChallenges.map((challenge, index) => (
              <div key={`${challenge.country}-${index}`} className="flex items-center justify-between p-2 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
                <div className="flex items-center space-x-2 space-x-3">
                  <div className="w-5 h-5 w-6 h-6 bg-primary-600 rounded-full flex items-center justify-center text-white text-xs font-medium flex-shrink-0">
                    {index + 1}
                  </div>
                  <div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-600 pt-4">
          <div className="grid grid-cols-3 gap-2 gap-4 text-center">
            <div>
              <p className="text-base text-lg font-medium text-gray-900 dark:text-white">
