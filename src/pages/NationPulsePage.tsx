...
const NationPulsePage = () => {
  ...
  const exportJSON = () => {
    ...
    <div className="w-full space-y-3">
      {/* Top Bar: Filters and Actions - Compact and Organized (Matching Companies Page) */}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3">
        <div className="card-glass p-3 rounded-lg hover:shadow-lg transition-all duration-200 group relative overflow-hidden h-full flex flex-col bg-cyan-50/50 dark:bg-cyan-950/30">
          ...
          <div className="relative flex items-center justify-between flex-1">
            <div className="min-w-0 flex-1">
              <p className="text-xs font-medium text-slate-500 dark:text-slate-400 mb-1 uppercase tracking-wide">Avg Life Expectancy</p>
              <p className="text-2xl font-medium text-slate-700 dark:text-slate-200 mb-1">{analytics.regional_averages.life_expectancy.toFixed(1)}</p>
        ...
        <div className="card-glass p-3 rounded-lg hover:shadow-lg transition-all duration-200 group relative overflow-hidden h-full flex flex-col bg-emerald-50/50 dark:bg-emerald-950/30">
          ...
          <div className="relative flex items-center justify-between flex-1">
            <div className="min-w-0 flex-1">
              <p className="text-xs font-medium text-slate-500 dark:text-slate-400 mb-1 uppercase tracking-wide">Avg GDP per Capita</p>
              <p className="text-2xl font-medium text-slate-700 dark:text-slate-200 mb-1">${analytics.regional_averages.gdp_per_capita.toFixed(0)}</p>
        ...
        <div className="card-glass p-3 rounded-lg hover:shadow-lg transition-all duration-200 group relative overflow-hidden h-full flex flex-col bg-indigo-50/50 dark:bg-indigo-950/30">
          ...
          <div className="relative flex items-center justify-between flex-1">
            <div className="min-w-0 flex-1">
              <p className="text-xs font-medium text-slate-500 dark:text-slate-400 mb-1 uppercase tracking-wide">Avg Health Spend</p>
              <p className="text-2xl font-medium text-slate-700 dark:text-slate-200 mb-1">{analytics.regional_averages.health_expenditure.toFixed(1)}%</p>
              <p className="text-xs text-slate-500 dark:text-slate-400">Of GDP</p>
                    </div>
        ...
        <div className="card-glass p-3 rounded-lg hover:shadow-lg transition-all duration-200 group relative overflow-hidden h-full flex flex-col bg-amber-50/50 dark:bg-amber-950/30">
          ...
          <div className="relative flex items-center justify-between flex-1">
            <div className="min-w-0 flex-1">
              <p className="text-xs font-medium text-slate-500 dark:text-slate-400 mb-1 uppercase tracking-wide">Investment Opportunities</p>
              <p className="text-2xl font-medium text-slate-700 dark:text-slate-200 mb-1">{investmentOpportunities.length}</p>
              <p className="text-xs text-slate-500 dark:text-slate-400">Countries Analyzed</p>
            </div>
      ...
      {/* Top Countries by Key Metrics - Compact Card Grid */}
      {regionalChartData.length > 0 && (
        <div className="card-glass p-4 rounded-lg">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <BarChart3 className="h-4 w-4 text-cyan-600 dark:text-cyan-400" />
              <h3 className="text-base font-medium text-slate-700 dark:text-slate-200">Top Countries by Key Metrics</h3>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-2">
            {regionalChartData.slice(0, 10).map((item: any, index: number) => (
              <div key={index} className="card-glass p-3 rounded-lg border border-slate-200/50 dark:border-slate-700/50 hover:shadow-md transition-all">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="text-sm font-medium text-slate-700 dark:text-slate-200 truncate flex-1">{item.country}</h4>
              </div>
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center">
                    <span className="text-xs text-slate-500 dark:text-slate-400">Life Expectancy</span>
                    <span className="text-sm font-medium text-cyan-600 dark:text-cyan-400">{item.lifeExpectancy.toFixed(1)}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-xs text-slate-500 dark:text-slate-400">Health Spend</span>
                    <span className="text-sm font-medium text-emerald-600 dark:text-emerald-400">{item.healthSpend.toFixed(1)}%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-xs text-slate-500 dark:text-slate-400">GDP/Capita</span>
                    <span className="text-sm font-medium text-indigo-600 dark:text-indigo-400">${item.gdpPerCapita.toFixed(0)}k</span>
                  </div>
                  </div>
                </div>
            ))}
      ...
      {/* Healthcare Investment Opportunities - All Countries from Database */}
      <div className="card-glass p-4 rounded-lg">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            <Target className="h-4 w-4 text-cyan-600 dark:text-cyan-400" />
            <h3 className="text-base font-medium text-slate-700 dark:text-slate-200">Healthcare Investment Opportunities</h3>
        ...
        {loading ? (
          <div className="flex items-center justify-center p-8">
            ...
            <span className="ml-3 text-slate-600 dark:text-slate-400">Loading investment opportunities...</span>
                  </div>
        ) : filteredOpportunities.length === 0 ? (
          <div className="text-center p-8">
            <p className="text-slate-500 dark:text-slate-400">No investment opportunity data available.</p>
                  </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {filteredOpportunities.map((opp: any) => {
              ...
              return (
                <div 
                  key={opp.countryKey} 
                  className={`card-glass p-4 rounded-lg border transition-all duration-200 hover:shadow-lg ${
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1 min-w-0">
                      <h4 className="text-base font-medium text-slate-700 dark:text-slate-200 mb-1 flex items-center gap-2 truncate">
      ...
      {/* Country Details Section - Compact and Detailed */}
        ...
        <div className="card-glass p-4 rounded-lg">
          <div className="flex items-center justify-between mb-4">
            ...
            >
              ...
              <ChevronDown className={`h-4 w-4 transition-transform ${expandedCountry === selectedCountry ? 'transform rotate-180' : ''}`} />
            </button>
        </div>
            ...
            <div className="space-y-4">
              ...
              {data.population[selectedCountry] && (
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2">
                  <div className="card-glass p-2.5 rounded-lg bg-cyan-50/50 dark:bg-cyan-950/30">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">Life Expectancy</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">{data.population[selectedCountry].life_expectancy || 0} yrs</p>
          </div>
                  <div className="card-glass p-2.5 rounded-lg bg-blue-50/50 dark:bg-blue-950/30">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">Population</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">{((data.population[selectedCountry].population_size || 0) / 1000000).toFixed(1)}M</p>
          </div>
                  <div className="card-glass p-2.5 rounded-lg bg-red-50/50 dark:bg-red-950/30">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">Under-5 Mortality</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">{data.population[selectedCountry].mortality?.under_five_rate || 0}</p>
        </div>
                  <div className="card-glass p-2.5 rounded-lg bg-purple-50/50 dark:bg-purple-950/30">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">Maternal Mortality</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">{data.population[selectedCountry].mortality?.maternal_ratio || 0}</p>
          </div>
                  <div className="card-glass p-2.5 rounded-lg bg-green-50/50 dark:bg-green-950/30">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">Annual Births</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">{((data.population[selectedCountry].birth?.annual_births || 0) / 1000000).toFixed(1)}M</p>
          </div>
                  <div className="card-glass p-2.5 rounded-lg bg-orange-50/50 dark:bg-orange-950/30">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">Growth Rate</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">{data.population[selectedCountry].population_growth_rate || 0}%</p>
        </div>
      </div>
              )}
              ...
              {data.healthcare_infrastructure[selectedCountry] && (
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2">
                  <div className="card-glass p-2.5 rounded-lg">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">Physicians/10k</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">{data.healthcare_infrastructure[selectedCountry].health_workforce?.physicians_per_10k || 0}</p>
          </div>
                  <div className="card-glass p-2.5 rounded-lg">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">Nurses/10k</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">{data.healthcare_infrastructure[selectedCountry].health_workforce?.nurses_per_10k || 0}</p>
          </div>
                  <div className="card-glass p-2.5 rounded-lg">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">Health Spend %</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">{data.healthcare_infrastructure[selectedCountry].health_expenditure?.percentage_of_gdp || 0}%</p>
        </div>
                  <div className="card-glass p-2.5 rounded-lg">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">Per Capita (USD)</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">${data.healthcare_infrastructure[selectedCountry].health_expenditure?.per_capita_usd || 0}</p>
        </div>
                  <div className="card-glass p-2.5 rounded-lg">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">Water Access</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">{data.healthcare_infrastructure[selectedCountry].water_sanitation?.drinking_water_access || 0}%</p>
        </div>
      </div>
              )}
              ...
              {data.economic_indicators[selectedCountry] && (
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2">
                  <div className="card-glass p-2.5 rounded-lg">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">GDP Total</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">${data.economic_indicators[selectedCountry].gdp?.total_usd_billions || 0}B</p>
        </div>
                  <div className="card-glass p-2.5 rounded-lg">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">GDP/Capita</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">${data.economic_indicators[selectedCountry].gdp?.per_capita_usd || 0}</p>
          </div>
                  <div className="card-glass p-2.5 rounded-lg">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">GDP Growth</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">{data.economic_indicators[selectedCountry].gdp?.growth_rate || 0}%</p>
        </div>
                  <div className="card-glass p-2.5 rounded-lg">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">Inflation</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">{data.economic_indicators[selectedCountry].inflation_rate || 0}%</p>
      </div>
                  <div className="card-glass p-2.5 rounded-lg">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">FDI Inflow</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">${data.economic_indicators[selectedCountry].foreign_investment?.fdi_inflow_millions || 0}M</p>
        </div>
        </div>
              )}
              ...
              {data.disease_immunization[selectedCountry] && (
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2">
                  <div className="card-glass p-2.5 rounded-lg">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">HIV Prevalence</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">{data.disease_immunization[selectedCountry].disease_prevalence?.hiv_prevalence || 0}%</p>
      </div>
                  <div className="card-glass p-2.5 rounded-lg">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">Malaria Incidence</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">{data.disease_immunization[selectedCountry].disease_prevalence?.malaria_incidence || 0}</p>
                </div>
                  <div className="card-glass p-2.5 rounded-lg">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">TB Incidence</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">{data.disease_immunization[selectedCountry].disease_prevalence?.tuberculosis_incidence || 0}</p>
                  </div>
                  <div className="card-glass p-2.5 rounded-lg">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">DTP3 Coverage</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">{data.disease_immunization[selectedCountry].immunization_coverage?.dtp3 || 0}%</p>
                  </div>
                  <div className="card-glass p-2.5 rounded-lg">
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-0.5">Measles Coverage</p>
                    <p className="text-lg font-medium text-slate-700 dark:text-slate-200">{data.disease_immunization[selectedCountry].immunization_coverage?.measles || 0}%</p>
                  </div>
                    </div>
              )}
                    </div>
