		...
		<div className="min-h-screen bg-[var(--color-background-default)] text-[var(--color-text-primary)] relative">
				...
				<div className="max-w-7xl mx-auto px-4 md:px-6">
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
						...
						<div className="space-y-4">
							...
							<h3 className="text-imagine-h3-mobile md:text-imagine-h3 text-[var(--color-text-primary)] tracking-tight">
								AI Co-pilot for Deals & Funding
							</h3>
							<p className="text-imagine-body-mobile md:text-imagine-body text-[var(--color-text-secondary)]">
            ...
            <section className="page-container section">
                <div className="flex items-end justify-between mb-4">
                    <h2 className="text-2xl md:text-3xl font-semibold">From Arion</h2>
